      ...
      <hr className="md:mb-2 mb-5 md:mt-5 " />
        <div className="flex justify-center md:hidden  gap-3">
          <div className='flex max-md:flex-col mt-1  gap-5'>
            <p className='text-sm text-gray-500 flex items-center gap-1'><FaStar /> Expertise:</p>
          ...
          <div className='flex max-md:flex-col  gap-3'>
            <p className='text-sm text-gray-500  gap-1'><span className='text-lg  text-white px-4 py-1 rounded-full font-semibold  bg-gradient-to-r  from-pink-400 to-rose-500 '>{subject}</span></p>
