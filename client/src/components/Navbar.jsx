    ...
    <header className='header'>
      ...
      <Link to='/'><img src="/logo.png" alt="Logo" className='w-40' /></Link>
        ...
        <ul className='nav-link mt-[-5px] max-md:hidden text-[#353452] text-sm'>
          ...
          <li>
            <Link to='/find-teachers' className='flex flex-col items-center bg-gradient-to-r  from-fuchsia-500 to-indigo-400  bg-clip-text '><IoSearchOutline className='text-2xl' />Find Teachers</Link>
          </li>
          <li>
            {isAuthenticated ? (
              <div className='flex justify-center items-center gap-3'>
                <Link to='/appointments' className='flex flex-col items-center pt-1'><BsClockHistory className='text-xl' />Appointments</Link>
              </div>
            ) : null}
          </li>
          <li>
