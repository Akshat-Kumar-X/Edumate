        ...
        <div className='flex max-md:flex-col-reverse items-center px-9 mt-16'>
            <div className='flex-1 ps-5 flex flex-col justify-start  max-md:mt-10'>
                ...
                <p className='text-gray-500 text-sm mt-7 font-medium'>
                    Please select your role to proceed with sign-in. Whether you're a  <br className='hidden md:inline-block' />  student looking to connect with your teachers or a teacher ready  <br className='hidden md:inline-block'  />  to manage your appointments, we're here to help you get started.
                </p>
                <Link to='/find-teachers' className='flex mt-7 text-lg w-[210px] items-center gap-1 text-white px-6 py-1 rounded-[2px] bg-gradient-to-r from-fuchsia-400 to-purple-600 hover:from-fuchsia-500 hover:to-purple-700 duration-300'>View all teachers <LiaLongArrowAltRightSolid /></Link>
            </div>
