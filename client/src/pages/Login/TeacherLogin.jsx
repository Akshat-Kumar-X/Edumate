            ...
            <div className='flex-1 flex items-center'>
              <div className='flex flex-col w-full bg-white p-10 text-black rounded-md '>
                ...
                <h1 className='text-[#353452] text-5xl  font-semibold mb-5'>
                  <span className='bg-gradient-to-r from-pink-400 to-rose-500 text-transparent bg-clip-text font-bold'>Teacher</span> Login
                </h1>
                <p className='mb-4 text-gray-500'>Connect With Students Around the World</p>
